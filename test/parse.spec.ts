...
it('parses a query string value', () => {
	const encoded = intoHex(parseQueryStringValue('%E1%B8m%C6%5E%1A%11%DE%16%90%1F%26%98%82%80r%40%C1%7Fr'));
	expect(encoded).toMatchInlineSnapshot(`"cabf1b0337adfb62bc0b50f15bce770e84791763"`);
});
